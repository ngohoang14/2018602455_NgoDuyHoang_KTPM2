...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'form-login-text'     => 'Nếu bạn đã có tài khoản, hãy đăng nhập với email.',
            'invalid-credentials' => 'Please check your credentials and try again.',
            'new-customer'        => 'Bạn chưa có tài khoản?',
        ...
        'account' => [
            ...
            'profile'   => [
                ...
                'female'                  => 'Female',
                'first-name'              => 'Họ của bạn',
                'gender'                  => 'Gender',
                'last-name'               => 'Tên của bạn',
                'male'                    => 'Male',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'mini-cart' => [
                ...
                'offer-on-orders'      => 'Nhận nhiều khuyến mại với lần order đầu tiên.',
                'remove'               => 'Remove',
                'see-details'          => 'See Details',
